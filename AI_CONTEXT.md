...
* Formal technical and architectural decisions (ADRs) confirmed by the developer are recorded as Markdown files under `docs/decisions/` (e.g., `docs/decisions/0001-database-provider.md`) and referenced in `AI_CONTEXT.md`.
